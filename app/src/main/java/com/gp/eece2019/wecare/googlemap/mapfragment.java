package com.gp.eece2019.wecare.googlemap;
...
public class mapfragment extends Fragment implements OnMapReadyCallback,
    ...
    public void onViewCreated(View view,@Nullable Bundle savedInstanceState) {
        ...
        Hos = (Button) getView().findViewById(R.id.B_hopistals);
        Search = (Button) getView().findViewById(R.id.B_search);
    ...
    public void onClick(View v)
    {
        ...
        {
            case R.id.B_search:
                EditText tf_location =  getView().findViewById(R.id.TF_location);
    ...
    private String getUrl(double latitude , double longitude , String nearbyPlace)
    {
        ...
        googlePlaceUrl.append("&key="+"AIzaSyCViXtvpG503yIWDNQtI6P_EAeepaJWF_o");
